...
public class TestFilterMap {
    ...
    public void filterMapByKey() {
        ...
        Map<Integer, String> collect2 = hosting.entrySet().stream().filter(map -> map.getKey() <= 3)
    ...
    public void predicateFilter2() {
        Map<Integer, String> filteredMap = filterByValue(hosting, x -> x.contains("heroku") || x.contains("aws"));
        System.out.println(filteredMap);
    }
}
